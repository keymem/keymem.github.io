...
// В этом файле - процедуры для доступа к файлам с секретами через webdav
...
function UploadSecretsOnGoogleDrive(evt) {
    gapi.client.load('drive', 'v2', function () {
        ...
        async function fetchAsync(url) {
            ...
            //let response.setHeader("Set-Cookie", "Secure;SameSite=None");
            let response.setHeader("Set-Cookie", "HttpOnly;Secure;SameSite=None");
